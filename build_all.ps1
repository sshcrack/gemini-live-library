...
.\gradlew clean build
Move-Item "./build/libs/*.jar" "both_loaders/gemini_live_$modVersion-$activeBranch.jar" -Force

git checkout $switchToBranch
.\gradlew clean build
Move-Item "./build/libs/*.jar" "both_loaders/gemini_live_$modVersion-$switchToBranch.jar" -Force
